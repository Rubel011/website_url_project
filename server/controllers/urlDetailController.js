...
module.exports.retriveUrlDataByUserId = async (req, res) => {
    try {
        ...
        res.status(200).json(successResponse(200, documents));
...
module.exports.addNewUrlData = async (req, res) => {
    try {
        ...
        if (await Domain.findOne({ domainName: url })) {
        ...
        res.status(200).json(successResponse(200, "Website data has been successfully stored in the database."));
    } catch (err) {
